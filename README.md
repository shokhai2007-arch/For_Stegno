...
* **Linux**: You can also build a `.deb` package for easy installation using the provided GitHub Actions workflow.
* **Windows**: A standalone `.exe` file can be generated using PyInstaller with the GitHub Actions workflow.
